...
nmap <leader>a :w!\|:Sayonara<cr>

" Fuck ex mode
nnoremap Q <nop>

" I want persistent undo
set undofile
...
autocmd BufNewFile,BufRead Vagrantfile setlocal filetype=ruby tabstop=2 softtabstop=2 shiftwidth=2 textwidth=120 smarttab expandtab
