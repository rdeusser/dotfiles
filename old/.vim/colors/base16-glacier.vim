" Base16 glacier (https://github.com/chriskempson/base16)
" Scheme: Robert Deusser
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-glacier.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-glacier"
